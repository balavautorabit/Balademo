...
public class OpportunityTest_2 {
...
String path= this.getClass().getProtectionDomain().getCodeSource().getLocation().toURI().getPath() + File.separator;
	...
	driver= recorderObj.Browser("autorabit.com-Ikgo8P","OpportunityTest_2",path) ;
  ...
  public void testOpportunity() throws Exception {
	...
	Actions action = new Actions(driver);
	    ...
	    driver.findElement(By.xpath("//div[@id='ep']/div[2]/div[3]/table/tbody/tr[3]/td[2]/div/input")).sendKeys("Demo-Test2");
